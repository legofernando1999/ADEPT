...
# create dict
dict_KLUT = {'kP_param': kP_param, 'kP_model': kP_model, 'kAg_param': kAg_param, 'kAg_model': kAg_model,
          'kD_param': kD_param, 'kD_scale': kD_scale, 'SR_param': SR_param, 'SR_model': SR_model}

# save json
path = current_file_path = Path(__file__).parent.resolve()
file_name = path / 'sample.json'
with open(file_name, 'w') as file:
    json.dump(dict_KLUT, file)
